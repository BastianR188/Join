...
document.addEventListener('click', function (event) {
  ...
  if (contact && contactInputField) {
    if (!contactInputField.contains(event.target) && !contact.contains(event.target)) {
...
document.addEventListener('click', function (event) {
  ...
  let categoryInputField = document.getElementById('categoriesInputField');
  if (category && categoryInputField) {
    if (!category.contains(event.target) && !categoryInputField.contains(event.target)) {
      closeCategoryDropDown();
    }
  }
});
...
document.addEventListener('keydown', function (event) {
  ...
  if (event.key === "Escape") {
    if (contactAdd && !contactAdd.classList.contains('show')) {
      if (category && categoryInputField && contact && contactInputField) {
        closeAll();
      }
    } else {
