...
async function submitSignUp() {
  ...
  if (!minPasswordLength())
    return displayErrorMessage(loginMessage, false, "passwordLength");
...
function getInputValues(contact) {
  ...
  let user = letUser(nameInput, emailInput, passwordInput, id, initialValue);
  return user;
}

function letUser(nameInput, emailInput, passwordInput, id, initialValue) {
  return {
...
/**
 * This functiion checks the length of the password
 * @returns true if valid, false otherwise
 */
