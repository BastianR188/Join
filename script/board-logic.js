...
function setAddTaskStyle() {
  if (showTaskForm == "Add-Task" && window.innerWidth < 768) {
    document.getElementById("form-content").style.setProperty("flex-direction", "column");
    document.getElementById("middle-line").style.display = "none";
  }
  if (showTaskForm == "Add-Task" && window.innerWidth >= 768) {
    document.getElementById("form-content").style.setProperty("flex-direction", "row");
    document.getElementById("middle-line").style.display = "block";
  }
}
...
async function editTask(taskId) {
  ...
  if (window.innerWidth > 768) {
    ...
    changeVersion();
    document.getElementById("right").classList.remove("right-container");
  }
}
...
/**
 * removes all red required asterisks or references
 */
...
/**
 * Sets the required style properties of the window
 */
function setStyleWindow() {
  document.getElementById("task-detailed-container").style.overflowY = "scroll";
  document.getElementById("task-detailed-container").style.overflowX = "hidden";
  document.getElementById("create-clear-btn").classList.remove("d-none");
  document.getElementById("task-detailed-edit-content").classList.remove("d-none");
  document.getElementById("create-clear-button").classList.add("d-none");
}

/**
 * Sets the required style properties of the delete btn
 */
function setStyleDeleteBtn() {
  let cancelButton = document.getElementById("clear-btn");
...
/**
 * Sets the required style properties of the create btn
 */
function setStyleCreateBtn() {
...
/**
 * Sets the required style properties of the form
 * @returns {any}
 */
function setStyleForm() {
  ...
  document.getElementById("form-content").style.padding = "0 16px 16px 16px";
  document.getElementById("create-clear-btn").style.width = "auto";
  document.getElementById("create-clear-btn").style.justifyContent = "flex-end";
  document.getElementById("required-text").style.display = "none";
}
...
function getEditTaskData() {
  ...
  let actualTask = setActualTaskIn(id, title, description, selectedDateISO, category, section);
  return actualTask;
}

/**
 * sets the values of the current task
 */
function setActualTaskIn(id, title, description, selectedDateISO, category, section) {
  return {
    id: id,
    title: title,
...
/**
 * This is the loop function for searching
 * @param {any} search
 * @returns {any}
 */
